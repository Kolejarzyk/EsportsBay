...
export class UserService
{
    ...
    getById(_id: string) {
        return this.http.get(this.config.apiUrl + '/api/User/' + _id, this.jwt()).map((response: Response) => response.json());
    }
    ...
    delete(_id: string) {
        return this.http.delete(this.config.apiUrl + '/api/User/' + _id, this.jwt());
    }
